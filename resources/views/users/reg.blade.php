...
<form class="form-signin" action="/user/reg" method="post">
    ...
    <input type="text" name="username" id="inputNickName" class="form-control" placeholder="nickname" required autofocus>
    ...
    <input type="text" name="tel"  class="form-control" placeholder="@" required autofocus>
